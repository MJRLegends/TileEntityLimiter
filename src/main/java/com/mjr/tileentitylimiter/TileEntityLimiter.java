...
@Mod(modid = TileEntityLimiter.MODID, version = TileEntityLimiter.VERSION, dependencies = "required-after:forge@[14.23.1.2555,);", serverSideOnly = true, acceptableRemoteVersions = "*", certificateFingerprint = "b02331787272ec3515ebe63ecdeea0d746653468")
